...
class LLMGradientAttribution(Attribution):
    ...
    def attribute(
        ...
        **kwargs,
        ...
        attr_list = []
        neuron_attr_dict = {}
        for cur_target_idx, token in enumerate(target_tokens):
            ...
            attr_copy = attr.clone()
            neuron_attr_dict[self.tokenizer.decode(token)] = {token: attr_copy.squeeze(0)[i] for i, token in enumerate(input_tokens)}
        ...
        return neuron_attr_dict, LLMAttributionResult(
            seq_attr,
